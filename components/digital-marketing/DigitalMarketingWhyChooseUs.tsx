  ...
  const reasons = [
    {
      ...
      description:
        'We understand that every business is unique. Our solutions are tailored to fit your specific needs and goals.',
    },
    {
      icon: <IoStatsChartSharp className="w-10 h-10 text-winny" />,
      title: 'Proven Results',
      description:
        "We focus on delivering measurable results. From increasing traffic to improving conversion rates, we'll show you the impact of our work.",
    },
    {
      icon: <FaUsers className="w-10 h-10 text-yelly" />,
      title: 'Experienced Team',
      description:
        'Our team of digital marketing experts has years of experience helping businesses succeed online.',
    },
    {
      icon: <FaChartLine className="w-10 h-10 text-winny" />,
      title: 'Transparent Reporting',
      description:
        'Stay informed about the performance of your campaigns with detailed and transparent reports.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-white max-w-2xl mx-auto leading-relaxed">
            Partner with us for digital marketing services that deliver real business growth and
        ...
        <div className="flex flex-wrap justify-center items-stretch gap-8 mx-auto">
          {reasons.map((reason, index) => (
            ...
            >
              ...
              {hoveredIndex === index && (
                <div className="absolute bottom-4 right-4 text-yelly">→</div>
              )}
            </motion.div>
          ))}
        </div>
