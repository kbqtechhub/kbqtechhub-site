...
import { FaChartBar, FaChartLine, FaCogs, FaRegComments, FaRocket } from 'react-icons/fa';
...
export default function DigitalMarketingProcess() {
  const processSteps: ProcessStep[] = [
    ...
    },
    {
      ...
      title: 'Optimization',
      description:
        'We continuously optimize campaigns to improve results and ensure you get the best return on investment.',
      icon: <FaCogs size={32} />,
    },
    {
      id: 5,
      ...
      description:
        'We provide you with regular reports and analyze performance to make data-driven decisions.',
