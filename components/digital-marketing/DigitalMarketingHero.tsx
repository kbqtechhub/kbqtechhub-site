    ...
    <section className="relative overflow-hidden">
      <div className="min-h-[30rem] sm:min-h-[25rem] md:h-[35rem] py-8 sm:py-5 md:py-10 bg-light-black flex flex-col gap-8 sm:gap-5 md:gap-10 rounded-b-[3rem] sm:rounded-b-[5rem] md:rounded-b-[10rem] relative">
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-6xl text-white font-extrabold text-center mb-4 sm:mb-6 md:mb-8 leading-snug sm:leading-tight tracking-tight">
            ...
            with <span className="text-orange-500">Digital Marketing</span>
          </h1>
          <p className="text-sm sm:text-base md:text-xl text-center text-gray-300 max-w-2xl mx-auto leading-relaxed font-light tracking-wide px-4 sm:px-0">
            <span className="text-purple-500">We drive</span>{' '}
            <span className="text-red-500">traffic</span>, generate{' '}
            <span className="text-indigo-500">leads</span>, and{' '}
            <span className="text-blue-500">increase sales</span>
            <span className="block mt-2">
              through <span className="text-green-500">strategic digital marketing</span>.
            </span>
          </p>
        </motion.div>
      ...
      >
        <h2 className="text-white text-center text-base sm:text-lg md:text-2xl font-medium leading-relaxed px-2 sm:px-0">
          In today's competitive marketplace, effective digital marketing is essential for growth.
          At <span className="text-orange-500">KBQ TECH-HUB</span>, we create tailored marketing
          strategies that drive <span className="text-cyan-500">engagement</span> and{' '}
          <span className="text-blue-500">conversions</span>, ensuring{' '}
          <span className="text-green-500">measurable business results</span>.
        </h2>
      </motion.div>
    </section>
  );
