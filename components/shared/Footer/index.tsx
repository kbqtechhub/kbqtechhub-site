  ...
  return (
    <section className="border-t border-pure-black">
      <section className="mx-2 md:mx-4">
        <footer
          className={`min-h-[50vh] w-full border-2 border-graphite-gray rounded-3xl border-dashed p-4 md:p-10 max-w-7xl mx-auto my-8 flex flex-col gap-8`}
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-16 md:gap-0">
            <div className="flex-1 w-full">
              <h2 className="text-3xl md:text-5xl text-graphite-gray font-black">
                One Hub, Endless Digital Possibilities.
              </h2>
              <form className="flex flex-col md:flex-row gap-3 items-start md:items-center">
                <input
                  type="email"
                  placeholder="Enter your email address"
                  className="w-full md:w-1/2 px-3 text-white py-2 my-4 bg-darker-gray outline-none rounded-lg hover:bg-dark-gray placeholder:italic"
                />
                <button
                  type="submit"
                  className="bg-gold font-medium text-white py-2 px-6 rounded-lg hover:bg-muted-yelly w-full md:w-auto"
                >
                  Subscribe
                </button>
              </form>
          ...
          <div className="w-full flex flex-col items-center gap-10 justify-center">
            <h1 className="text-5xl md:text-[8rem] font-black text-gold text-center">
              KBQ TECH-HUB
            </h1>
            <div className="text-center">
              <p className="text-center text-graphite-gray text-sm md:text-base">
