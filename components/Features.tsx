                ...
                <div className='flex flex-col gap-4 sm:gap-6 md:gap-8'>
                    {features.map((feature, index) => (
                        <div key={index} className='flex gap-3 sm:gap-4'>
                            ...
                            <div>
                                <h3 className='text-base sm:text-lg md:text-xl text-gold font-medium'>{feature.title}</h3>
                                <p className='text-xs sm:text-sm md:text-base text-graphite-gray'>{feature.description}</p>
                            </div>
                        </div>
                    ))}
                </div>
