...
const process = ['Idea Validation', 'Wireframing & Prototype', 'Agile Development', 'Testing & Quality Assurance', 'Launch & Continuous Support']
    ...
    return (
        <section className='max-w-4xl mx-auto w-[90%] process_section p-10 min-h-[50vh] flex flex-col md:flex-row justify-between gap-10 md:gap-10'>
            <div className='w-full md:w-[45%] self-center flex items-start flex-col gap-8'>
                ...
                <h3 className='text-2xl md:text-4xl text-graphite-gray font-black leading-tight'>Unlock Your App's Potential with Our Proven Process!</h3>
            ...
            <div className='w-full md:w-[55%] flex justify-end'>
                <ul className='flex flex-col gap-8 w-full md:w-[95%] relative'>
                    {process.map((item, index) => (
                        <li key={index} className={`bg-yelly text-soft-black p-4 rounded-lg flex items-center gap-4 relative
