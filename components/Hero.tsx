            ...
            <section className='min-h-[40vh] md:h-[70vh] bg-gradient-to-b from-soft-black to-off-black rounded-3xl p-4 shadow-2xl flex items-center justify-center'>
                <div className='flex flex-col space-y-8'>
                    ...
                    <div className='flex flex-col md:flex-row gap-4 justify-center items-center'>
                        <button className='cursor-pointer border-2 w-full md:w-fit rounded-lg border-yelly bg-[#ffe69960] px-4 py-2'>Sign Up for Training</button>
                        <button className='cursor-pointer w-full md:w-fit rounded-lg bg-white text-soft-black px-4 py-2'>Explore Our Services</button>
                    </div>
                </div>
            </section>
        </section>
