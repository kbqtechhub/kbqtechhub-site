        ...
        <section className="w-full bg-off-black rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="blog-header">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-graphite-gray text-base">
                            {blog.readTime}
                        </span>
                    </div>
                    ...
                    <div className="space-y-3">
                        <h2 className="text-2xl font-bold line-clamp-2 text-white">
                            {blog.title}
                        </h2>
                        <p className="text-graphite-gray text-base line-clamp-3">
                            {blog.description}
                        </p>
                    </div>
            ...
            <div className="border-t border-dark-gray">
                <article className="p-6">
                    <p className="text-white text-base leading-loose whitespace-pre-wrap">
                        {blog.content}
                    </p>
                </article>
            </div>
