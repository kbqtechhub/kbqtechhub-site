    ...
    <section className="relative overflow-hidden">
      <div className="min-h-[30rem] sm:min-h-[25rem] md:h-[35rem] py-8 sm:py-5 md:py-10 bg-light-black flex flex-col gap-8 sm:gap-5 md:gap-10 rounded-b-[3rem] sm:rounded-b-[5rem] md:rounded-b-[10rem] relative">
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-xl text-center text-gray-300 max-w-2xl mx-auto leading-relaxed font-light tracking-wide px-4 sm:px-0">
            <span className="text-orange-500">Transform</span> your{' '}
            <span className="text-blue-500">online presence</span> with{' '}
            <span className="text-purple-500">stunning</span>,{' '}
            <span className="text-cyan-500">responsive</span> websites
            <span className="block mt-2">
              tailored to your <span className="text-green-500">unique business needs</span>.
            </span>
          </p>
        </motion.div>
      ...
      >
        <h2 className="text-white text-center text-base sm:text-lg md:text-2xl font-medium leading-relaxed px-2 sm:px-0">
          At <span className="text-purple-500">KBQ TECH-HUB</span>, we specialize in creating{' '}
          <span className="text-orange-500">high-performance</span> websites that drive{' '}
          <span className="text-cyan-500">growth</span> and{' '}
          <span className="text-red-500">engagement</span>. Whether you're looking to establish a{' '}
          <span className="text-green-500">new online presence</span> or revamp an existing site,
          our <span className="text-blue-500">expert team</span> will deliver a solution that meets
          your <span className="text-indigo-500">unique needs</span>.
        </h2>
      </motion.div>
    </section>
  );
