      ...
      <Slider {...settings}>
        {Array(4)
          ...
          .map((_, index) => (
            <div
              key={index}
              className="bg-soft-black max-w-[25rem] mx-auto relative border-[6px] md:border-[10px] border-background rounded-tl-[10%] rounded-tr-[10%] rounded-br-[10%] p-6 md:p-10 md:my-10 text-white"
            >
              <div className="flex flex-col gap-4 md:gap-6">
                <p className="text-base md:text-lg leading-relaxed">
                  Working with KBQ TECH-HUB was a game-changer. Their team developed a sleek,
                  responsive website for us that perfectly represents our brand. We've seen a 40%
