    ...
    <section className="relative overflow-hidden">
      <div className="min-h-[30rem] sm:min-h-[25rem] md:h-[35rem] py-8 sm:py-5 md:py-10 bg-light-black flex flex-col gap-8 sm:gap-5 md:gap-10 rounded-b-[3rem] sm:rounded-b-[5rem] md:rounded-b-[10rem] relative">
        ...
        >
          ...
          <p className="text-sm sm:text-base md:text-xl text-center text-gray-300 max-w-2xl mx-auto leading-relaxed font-light tracking-wide px-4 sm:px-0">
            <span className="text-purple-500">Mobile</span> and{' '}
            <span className="text-red-500">web apps</span> crafted for{' '}
            <span className="text-indigo-500">performance</span>,{' '}
            <span className="text-blue-500">security</span>,
            <span className="block mt-2">
              and <span className="text-green-500">user experience</span>.
            </span>
          </p>
        </motion.div>
      ...
      >
        <h2 className="text-white text-center text-base sm:text-lg md:text-2xl font-medium leading-relaxed px-2 sm:px-0">
          In today's digital era, having an app can set your business apart. At{' '}
          <span className="text-orange-500">KBQ TECH-HUB</span>, we design and develop applications
          that prioritize <span className="text-cyan-500">usability</span> and{' '}
          <span className="text-blue-500">functionality</span>, ensuring{' '}
          <span className="text-green-500">seamless user experiences</span>.
        </h2>
      </motion.div>
    </section>
  );
