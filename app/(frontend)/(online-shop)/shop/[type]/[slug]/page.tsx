        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              ...
              >
                <Button 
                  className="w-full bg-[var(--color-winny)] text-[var(--color-white)] hover:bg-[var(--color-muted-wine)] mt-4"
                >
                  Buy Now
                </Button>
              </Link>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-[var(--color-white)]/5 p-6 rounded-lg shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4">
                <div>
                  <span className="font-medium block text-[var(--color-graphite-gray)]">Processor</span> 
                ...
                <div>
                  <span className="font-medium block text-[var(--color-graphite-gray)]">Storage</span> 
                  <span className="text-lg">{item.specs.storage}</span>
                </div>
                <div>
                  <span className="font-medium block text-[var(--color-graphite-gray)]">Graphics</span> 
                  <span className="text-lg">{item.specs.graphics}</span>
                </div>
                <div>
                  <span className="font-medium block text-[var(--color-graphite-gray)]">Display</span> 
                  <span className="text-lg">{item.specs.display}</span>
                </div>
                <div>
                  <span className="font-medium block text-[var(--color-graphite-gray)]">Battery</span> 
            ...
            <div className="p-1">
              ...
              <p className="text-lg text-[var(--color-graphite-gray)]">{item.performance_summary}</p>
            </div>
              ...
              <div className="bg-[var(--color-light-yelly)]/10 p-6 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-2">
                  {item.pros.map((pro: string, index: number) => (
                    <li key={index} className="text-[var(--color-graphite-gray)] text-lg">{pro}</li>
                  ))}
                </ul>
              </div>
              <div className="bg-[var(--color-light-wine)]/10 p-6 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-2">
                  {item.cons.map((con: string, index: number) => (
                    <li key={index} className="text-[var(--color-graphite-gray)] text-lg">{con}</li>
                  ))}
                </ul>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              ...
              <h1 className="text-2xl md:text-3xl font-bold mb-3">{item.name}</h1>
              <div className="mb-4">
                <span className="text-2xl font-bold text-[var(--color-winny)]">{(item as Accessory).price}</span>
                <span className="text-sm ml-2 text-[var(--color-graphite-gray)]">Type: {(item as Accessory).type}</span>
              </div>
              <Link 
                href={item.affiliate_link} 
                target="_blank" 
          ...
          <div className="lg:col-span-2">
            <div className="p-1">
              ...
              <p className="text-lg text-[var(--color-graphite-gray)]">{(item as Accessory).description}</p>
            </div>
          </div>
        </div>
      )}
