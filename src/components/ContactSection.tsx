        ...
        <section className='flex flex-col md:flex-row gap-10 md:px-10'>
            <div className='flex-1 h-full flex flex-col gap-8'>
                <div className='flex flex-col gap-6'>
                    ...
                    <p className='text-graphite-gray'>Welcome to KBQ TECH-HUB, where endless digital possibilities await! We're here to help you navigate your digital journey. Whether you have questions, need support, or want to share your feedback, don't hesitate to reach out.</p>
                </div>
