        ...
        <section className="max-w-xl mx-auto w-full bg-gold rounded-3xl shadow-2xl p-10">
            ...
            <form className="flex flex-col gap-4 mt-4">
                <div className='flex gap-4 w-full'>
                    <input type="email" placeholder="Email" className="p-2 bg-white rounded-lg flex-1 text-darker-gray placeholder:text-dark-gray" />
                    <input type="text" placeholder="Name" className="p-2 bg-white rounded-lg flex-1 text-darker-gray placeholder:text-dark-gray" />
                </div>
