...
import { FaHashtag, FaSearchengin, FaAdversal, FaFileAlt, FaEnvelope, FaBullhorn } from 'react-icons/fa';

export default function DigitalMarketingServices() {
  const services = [
    {
      title: "Social Media Marketing",
      description: "Expand your brand's reach with data-driven social media strategies. We manage your social media channels, curate engaging content, and connect with your audience to boost engagement.",
    ...
    },
    {
      ...
      details: "On-page SEO, off-page SEO, and technical SEO to help you rank higher and reach your target audience.",
    ...
    },
    {
      ...
      details: "We create and manage Google Ads, Bing Ads, and social media ads to ensure your budget works for you.",
      icon: <FaAdversal className="text-4xl" />
    },
    {
      title: "Content Marketing",
      description: "High-quality content that educates, engages, and converts.",
      details: "Blog posts, infographics, videos, and email campaigns that reflect your brand's voice and build long-term relationships with your audience.",
      icon: <FaFileAlt className="text-4xl" />
    },
    {
      title: "Email Marketing",
      description: "Nurture relationships with your customers through targeted email campaigns.",
      details: "From newsletters to product promotions, we help you deliver the right message at the right time.",
    ...
    },
    {
      ...
      details: "We work with you to understand your goals, audience, and competitors to create an actionable digital marketing plan.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 md:mb-16">
          ...
          <p className="text-lg md:text-xl text-graphite-gray max-w-3xl mx-auto px-2">
            Comprehensive digital marketing solutions tailored to grow your online presence and drive results.
          </p>
        </div>
