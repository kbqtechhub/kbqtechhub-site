...
export default function AboutSection() {
    return (
        <section className='bg-[#fff] shadow-2xl min-h-[500px] h-auto py-16 md:h-[60vh] md:min-h-[70vh] rounded-3xl relative flex flex-col items-center justify-center overflow-hidden px-4'>
            ...
            <div className='max-w-2xl mx-auto w-full z-10'>
                <h2 className='text-xl sm:text-2xl md:text-3xl text-soft-black font-semibold text-center leading-normal'>
